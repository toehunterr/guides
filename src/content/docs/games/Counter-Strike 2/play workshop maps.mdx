---
title: How To Play Workshop Maps On Your CS2 Server
...
:::note
Currently there is a CS2 bug where some workshop collections won't load. You can install the [cs2_WorkshopDefaultMap](https://github.com/Cruze03/cs2_WorkshopDefaultMap) plugin to force a map from your collection to load. You MUST also have a GSLT for Workshop maps to load otherwise it won't download.
:::

**Here is what you need:**
- Workshop Collection ID with maps you want to use
- An active [GSLT (Game Server Token)](/games/counter-strike-2/create-gslt/)
...
5. Make sure `Workshop Type` is set to `Workshop Collection`
![workshop collection ID](../../../../assets/guide-images/workshop-collection-id.png)
6. Select `Workshop ID`, and put your Collection ID in there and restart your server.

After that, simply restart the server and all the maps will be available. Type `ds_workshop_listmaps` in your console to check. You also don't need to edit any mapgroup or mapcycle files as CS2 will automatically create one for you.
...
2. Make sure `Workshop Type` is set to `Single Workshop Map`.
3. Select Workshop ID, and put your map ID in there and restart the server.
