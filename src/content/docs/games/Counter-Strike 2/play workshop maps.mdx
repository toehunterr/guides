...
:::note
Currently there is a CS2 bug where some workshop collections won't load. You can install the [cs2_WorkshopDefaultMap](https://github.com/Cruze03/cs2_WorkshopDefaultMap) plugin to force a map from your collection to load. You MUST also have a GSLT for Workshop maps to load otherwise it wont download.
:::
