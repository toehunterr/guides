...
It's also worth noting that configs load in a specific order they're listed in this document when your CS2 server starts. So if you have the same convar in server.cfg and in gamemode_casual_server.cfg, the convar in the _server file will be the one that is used.
