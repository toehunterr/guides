...
**A:** You will only be automatically be refunded if you're within the 14-day refund period and have selected **immediate termination**. If you have selected end of billing cycle you will not receive an auto refund as people do this when they only want the server for 1 month. 
